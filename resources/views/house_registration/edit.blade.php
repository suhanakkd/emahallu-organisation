          ...
          <div class="container px-6 mx-auto grid">
            ...
            <form  action="{{url('house/update')}}" method="post">
              ...
              <label class="block text-sm" style="margin-bottom: 15px">
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" name="family_name"value="{{$edit->family_name}}"
                  placeholder=""
                />
              </label>
              ...
              <label class="block text-sm" style="margin-bottom: 15px">
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"name="holder_name"value="{{$edit->house_holder_name}}"
              ...
              <label class="block text-sm" style="margin-bottom: 15px">
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"name="address"value="{{$edit->address}}"
              ...
              <label class="block text-sm" style="margin-bottom: 15px">
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"name="house_number"value="{{$edit->house_number}}"
              ...
              <label class="block text-sm" style="margin-bottom: 15px">
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"name="ward"value="{{$edit->ward}}"
                ...
                <input
                  class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"name="panchayat"value="{{$edit->panchayat}}"
