        ...
        <table class="w-full whitespace-no-wrap">
          <thead>
            ...
            >
              ...
              <th class="px-4 py-3">House_holder_name</th>
          ...
          <tbody id="myTable"
            ...
            @foreach($release as $key=>$releas)
  <tr class="text-gray-700">
  <td class="px-4 py-3 text-sm">{{$releas->house_id}}</td>
  <td class="px-4 py-3 text-sm">{{$releas->house_holder_name}}</td>
  <td class="px-4 py-3 text-sm">{{$releas->address}}</td>
  <td class="px-4 py-3 text-sm">{{$releas->date}}</td>
 @endforeach
