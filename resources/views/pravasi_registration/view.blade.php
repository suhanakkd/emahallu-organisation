      ...
      <div class="w-full overflow-x-auto">
        <table class="w-full whitespace-no-wrap">
          ...
          <tbody id="myTable"
            ...
            @foreach($pravasi as $key=>$pravasi)
  <tr class="text-gray-700">
  <td class="px-4 py-3 text-sm">{{$pravasi->house_id}}</td>
  @foreach($pravasi->member as $mem)
  <td class="px-4 py-3 text-sm">{{$mem->name}}</td>
  @endforeach
  <td class="px-4 py-3 text-sm">{{$pravasi->country}}</td>

 <td class="px-4 py-3 text-sm">
 @if($pravasi->status==1)
 <a href="{{URL::to('pravasi/active/'.$pravasi->id)}}" class=""><button type="button"  class="btn btn-outline-warning" >Active</button></a> 


  </span>
  @endif
  @if($pravasi->status==0)
  <a href="{{URL::to('pravasi/deactive/'.$pravasi->id)}}" class=""><button type="button"  class="btn btn-outline-warning" >Deactive</button></a> 
