...
<form class="form-sample"  action="{{url('deathsave')}}" method="post" >
                          {{csrf_field()}}
...
<label class="block text-sm "style="margin-bottom:15px;">
                <span class="text-gray-700">Funeral place</span>
                <input
                  class="block w-full mt-1 text-sm 
                  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
                  form-input"
                  placeholder="" name="funeral_place" 
                />
              </label>
              <label class="block text-sm"style="margin-bottom:15px;">
                <span class="text-gray-700">Death Reason</span>
                <input
                  class="block w-full mt-1 text-sm 
                  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
                  form-input"
                  placeholder="" name="death_reason" 
                />
              </label> 

<label class="block text-sm"style="margin-bottom:15px;">
                <span class="text-gray-700">death_date</span>
                <input type="date"
                  class="block w-full mt-1 text-sm 
                  focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
                  form-input"
                  placeholder="" name="death_date"  required
                />
              </label>
