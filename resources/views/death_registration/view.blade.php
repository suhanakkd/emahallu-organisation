...
<!-- search end -->
        ...
        <table class="w-full whitespace-no-wrap">
          <thead>
            ...
            >
              ...
              <th class="px-4 py-3">Funeral place</th>
              <th class="px-4 py-3">Death reason</th>
              <th class="px-4 py-3">Death date</th>
              
            </tr>
          </thead>
          <tbody id="myTable"
            class="bg-white divide-y">
            @foreach($death as $key=>$dt)
  ...
  @endforeach
  <td class="px-4 py-3 text-sm">{{$dt->furnel_place}}</td>
  <td class="px-4 py-3 text-sm">{{$dt->death_reason}}</td>
