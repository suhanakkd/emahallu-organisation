        ...
        <table class="w-full whitespace-no-wrap">
          <thead>
            ...
            >
              ...
              <th class="px-4 py-3">Member_name</th>
          ...
          <tbody id="myTable"
            ...
            @foreach($birth as $key=>$birth)
            <tr class="text-gray-700">
  <td class="px-4 py-3 text-sm">{{$birth->house_id}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->child_name}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->date_of_birth}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->place_of_birth}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->blood_group}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->gender}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->father_name}}</td>
  <td class="px-4 py-3 text-sm">{{$birth->mother_name}}</td>
  @foreach($birth->house as $address)
  <td class="px-4 py-3 text-sm">{{$address->address}}</td>
@endforeach
 @endforeach
        <!-- Pagination -->
